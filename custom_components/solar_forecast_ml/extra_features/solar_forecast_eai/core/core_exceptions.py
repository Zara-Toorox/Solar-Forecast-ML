...
"""Exception classes for Solar Forecast Energy AI. @zara"""
...
class SolarForecastEAIException(Exception):
    """Base exception for Solar Forecast Energy AI @zara"""
...
class ConfigurationException(SolarForecastEAIException):
...
class DependencyException(SolarForecastEAIException):
...
class WeatherAPIException(SolarForecastEAIException):
...
class DataIntegrityException(SolarForecastEAIException):
...
class DataValidationException(SolarForecastEAIException):
...
class MLModelException(SolarForecastEAIException):
    """ML model error @zara"""
...
class CircuitBreakerOpenException(SolarForecastEAIException):
...
# Backward compatibility alias @zara
SolarForecastMLException = SolarForecastEAIException
