...
// Filled in setup() once vue-i18n has the active locale (resolved at module-load
// time via translateMonthShort below). Keep a fallback for misc helpers that
// run before setup (none currently, but defensive).
