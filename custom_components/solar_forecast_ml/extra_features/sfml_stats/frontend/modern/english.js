...
(function installModernEnglish() {
    ...
    const translations = new Map([
        ...
        ["Kennzahlen über frei wählbare Zeiträume, als CSV oder ZIP.", "Figures over any period you choose, as CSV or ZIP."],
        ["Von", "From"],
        ["Bis", "To"],
        ["Anzeigen", "Show"],
        ["Tag", "Day"],
        ...
        ["davon bepreist", "of which priced"],
        ["Alle Spalten", "All columns"],
        ["Korrekturen in {count} von {total} Zeiträumen", "Corrections in {count} of {total} periods"],
        ["Tag als CSV", "Day as CSV"],
        ["Monat als CSV", "Month as CSV"],
        ["Jahr als CSV", "Year as CSV"],
        ["Alles als ZIP", "Everything as ZIP"],
        ["Keine Werte in diesem Zeitraum.", "No figures in this period."],
        ["Kennzahlen werden geladen …", "Loading figures …"],
        ["Eine gültige Premium-Lizenz ist erforderlich.", "A valid Premium licence is required."],
        ["Kennzahlen konnten nicht geladen werden.", "Figures could not be loaded."],
        ["Kennzahlen", "Figures"],
        ["Einzeltag", "Single day"],
        ["Zeitraum", "Date range"],
        ["CSV-Import", "CSV import"],
        ["Verlauf", "History"],
        ["Übernehmen", "Apply"],
        ["Korrektur gespeichert.", "Correction saved."],
        ["Metrik", "Metric"],
        ["Metrik, Zeitraum und Zielsumme. Vor dem Speichern wird immer eine Vorschau angezeigt.", "Choose the metric, the period and the target sum. A preview is always shown before saving."],
        ["Start", "Start"],
        ["Ende", "End"],
        ["Zielsumme (kWh)", "Target sum (kWh)"],
        ["Gewichtung", "Weighting"],
        ["Nach Messwerten", "By measured values"],
        ["Gleichmäßig", "Uniform"],
        ["Zielsumme getroffen", "Target sum reached"],
        ["Gleichmäßige Verteilung, weil die Rohsumme 0 ist.", "Uniform distribution because the raw sum is 0."],
        ["Vorlage laden, Datei wählen und die Vorschau prüfen, bevor etwas übernommen wird.", "Download the template, choose a file and check the preview before anything is applied."],
        ["Vorlage herunterladen", "Download template"],
        ["Datei wählen", "Choose file"],
        ["Zeilen gesamt", "Rows total"],
        ["Übernommen", "Accepted"],
        ["Abgelehnt", "Rejected"],
        ["Zeile", "Line"],
        ["Grund", "Reason"],
        ["Abgedeckte Tage", "Days covered"],
        ["Summen-Delta", "Sum delta"],
        ["Betroffene Tage", "Affected days"],
        ["Ganzen Batch rückgängig", "Undo whole batch"],
        ["Diesen ganzen Batch rückgängig machen?", "Undo this whole batch?"],
        ["Batch rückgängig gemacht.", "Batch undone."],
        ["Preise und Monatskorrekturen", "Prices and monthly corrections"],
        ["Preise und Monatskorrekturen gehören zum Grid Price Monitor.", "Prices and monthly corrections belong to Grid Price Monitor."],
        ["Zur GPM-Seite", "Open the GPM page"],
        ["Ungültige Zeile", "Invalid row"],
        ["Ungültiges Datum", "Invalid date"],
        ["Datum liegt vor 2015", "Date is before 2015"],
        ["Nur abgeschlossene Tage", "Completed days only"],
        ["Unbekannte Metrik", "Unknown metric"],
        ["Ungültige Zahl", "Invalid number"],
        ["Doppelter Tag und Messwert", "Duplicate day and metric"],
        ["Ziel außerhalb des zulässigen Bereichs", "Target is outside the allowed range"],
        ...
        ["Abgeschlossene Tageswerte korrigieren oder fehlende Tage nachtragen.", "Correct completed daily values or backfill a missing day."],
        ["Korrigieren", "Correct"], ["Nachtragen", "Backfill"], ["Nachweis", "Evidence"],
        ["Stromrechnung", "Utility invoice"], ["Zählerportal", "Meter portal export"],
        ["Tagesprotokoll", "Signed daily report"], ["Nachtrag", "Backfill"],
        ["Hausverbrauch", "Home consumption"], ["Netzbezug", "Grid import"],
        ["Zählerbezug", "Meter import"], ["Netzeinspeisung", "Grid export"],
        ["Zählereinspeisung", "Meter export"], ["PV-Ertrag", "PV yield"],
        ["PV zu Akku", "PV to battery"], ["Netz zu Akku", "Grid to battery"],
        ["Heizstab", "Heating rod"], ["Wallbox", "Wallbox"],
    ...
    const dynamicTranslations = [
        [/^Bilanzabweichung (.+) %: (.+)$/, "Balance deviation $1%: $2"],
        [/^(.+) heute$/, "$1 today"],
