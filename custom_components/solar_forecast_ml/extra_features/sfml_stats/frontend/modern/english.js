...
(function installModernEnglish() {
    ...
    const translations = new Map([
        ...
        ["Strompreis (GPM)", "Grid prices (GPM)"],
        ["benötigt Lizenz", "requires a licence"],
        ["CSV-Import", "CSV import"],
        ["Monatskorrektur", "Monthly correction"],
        ["GPM nicht eingerichtet", "GPM is not set up"],
        ["GPM-Demo", "GPM demo"],
        ["Lizenz aktiv · Solar Forecast Energy AI", "Licence active · Solar Forecast Energy AI"],
        ["Lizenz aktiv", "Licence active"],
        ["Bestandsschutz · Lizenz empfohlen", "Grandfathered · licence recommended"],
        ["Demo · Lizenz erforderlich", "Demo · licence required"],
        ["Nächste günstige Stunde", "Next cheap hour"],
        ["Morgenpreise ab ca. 13:00", "Tomorrow's prices from about 13:00"],
        ["Morgenpreise liegen vor", "Tomorrow's prices are available"],
        ["Preiszusammensetzung", "Price composition"],
        ["Korrekturen", "Corrections"],
        ["Monatsübersicht", "Monthly overview"],
        ["Meine Stromrechnung", "My electricity bill"],
        ["Beispieldaten – mit Lizenz deine echte Rechnung", "Sample data – with a licence, your real bill"],
        ["Kalenderjahr", "Calendar year"],
        ["Abrechnungsjahr", "Billing year"],
        ["Erwartet", "Expected"],
        ["Tarifschema", "Tariff schedule"],
        ["günstige Stunden", "cheap hours"],
